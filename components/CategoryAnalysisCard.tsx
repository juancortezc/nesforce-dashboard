...
export default function CategoryAnalysisCard({ month = 'all', year = 'all', region = '', category = 'all', segment = 'all' }: any) {
  const { data, error, isLoading } = useSWR(
    `/api/program28-by-category?month=${month}&year=${year}&region=${region}&category=${category}&segment=${segment}`,
    fetcher
  );

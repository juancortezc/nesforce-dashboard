...
export default function TopParticipantsRedemptionCard({ month = 'all', year = 'all', category = 'all', segment = 'all' }: any) {
  const { data, error, isLoading } = useSWR(
    `/api/program28-top-participants?month=${month}&year=${year}&category=${category}&segment=${segment}`,
    fetcher
  );
